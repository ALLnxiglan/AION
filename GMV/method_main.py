...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='AION', help='Model name')
    ...
    parser.add_argument('--model_save_pth', type=str, default='./pretrain_model/', help='Model save path')
    ...
    parser.add_argument('--stream_step', type=float, default=0.125, help='Stream step size (days)')
    parser.add_argument('--bdl_stream_step', type=float, default=1, help='BDL stream step size (days)')
    parser.add_argument('--ga_loss_weight', type=float, default=0.5, help='Count CE loss weight')
    parser.add_argument('--boost_weight', type=float, default=0.1, help='Price loss weight')
